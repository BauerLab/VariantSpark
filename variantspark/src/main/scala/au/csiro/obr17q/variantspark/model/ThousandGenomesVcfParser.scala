...
private case class VcfRecord(individual: String, sampleType: String, bmi: Double = null, population: String = null, superPopulation: String = null, features: Vector)

class ThousandGenomesVcfParser (val VcfFileNames: String, val VariantCutoff: Int, val IndividualMeta: RDD[IndividualMap], val sc: SparkContext) extends VcfParser {
