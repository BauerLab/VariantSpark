...
We compare {\sc read.table} to one using the `VariantAnnotation' package. Reading the VCF file to a matrix with `readGT' is faster than reading a VCF file to a table using R's `read.table', at 116 seconds compared to 207 seconds,
