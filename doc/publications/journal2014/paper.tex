...
GraphML files generated using Mahout Cluster Dumper can be visualised using popular freely-available tools such as Gephi~\cite{ICWSM09154}. An example visualisation using the phase 3 dataset, with nodes coloured by super population, is shown in Figure XX.
