...
%DB: lets switch section 
% 1) increase samples \SevenPhaseone{} and \ThreePhasethree{} -> Hadoop scales: does not increase memory requirement, and runtime would have stayed the same with more resource
% 2) increase features \OnePhasethree, \ThreePhasethree, \FullPhasethree -> 
% that way we get around explaining why FullPhaseOne is worse than \SevenPhaseone
