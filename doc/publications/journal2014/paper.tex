...
%DB this probably is not the final URL...
The package is written in Java and available at \url{https://stash.csiro.au/users/bau04c/repos/bioinfbiglearning/browse}.
