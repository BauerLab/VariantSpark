...
\variantSpark{} utilizes {\sc Spark}, which allows for in-memory cashing and hence performs 85\% faster than Hadoop (29 min), 94\% faster than R (75 min), and 95\% faster than Python (103 min). 
