...
%TODO add value
To further demonstrate the scalability of \variantSpark{}, we also cluster the 1000 Genomes Project phase 3 data, which contains 3000 individuals from 5 superpopulations and as a result has over 80 Million variants. 
The uncompressed size of the phase 3 files is 770GB compared to the 161GB of the phase 1 dataset.
\variantSpark{} successfully completes the clustering in just 27 hours (see Table 2) with an ARI of XX. % if XX is smaller than 0.84 we need to explain more. 
...
In the supplementary material we benchmark this approach against reading the VCF file in using the `VariantAnnotation' package.
