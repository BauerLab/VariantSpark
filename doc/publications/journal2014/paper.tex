...
\begin{table}[h!]
\caption{The resources consumption on different subsets of the entire autosome (chromosomes 1-22). Memory specified is memory allocated to each executor.}
      \begin{tabular}{|c|ccc|ccc|c|c|}
        \hline
...
60\%		& 64	& 2	& 67min		& x	& 32	& x	\\
100\%	& 64	& 2	& 40min 48sec	& x	& 24	& 14hr 44min	\\
  \hline
      \end{tabular}
\end{table}
