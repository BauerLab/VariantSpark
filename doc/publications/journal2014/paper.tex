...
\section{Motivation:}
Processing genomic information from whole genome sequence studies pose computational challenges due to the unprecedented data volume, which render transitional approaches insufficient. 
...
Here we introduce the interface we developed between the standard variant format (VCF) and the scalable analysis library Mahout, which opens up the application of advanced, efferent machine learning algorithms to genomic data. 
\section{Results:}
