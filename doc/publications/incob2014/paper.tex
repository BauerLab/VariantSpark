...
For the \SixReal\ and \FullReal\ dataset, we ran the job on a PBS cluster of x nodes, with twelve CPU cores and 48GB of memory per node.
...
ARI=\frac{\sum_{ij}{{n_{ij}\choose 2}} - \left[ \sum_{i}{{a_i\choose2}} \right]}{bla} 
\end{eqnarray}
