...
\section*{Methods}
\subsection*{Datasets}
Trio data from the 1000 genomes project -> determine in the clustering can identify ancestry 
Sequence data from hapmap samples -> determine ethnic groups
Scaled down version of the hap map data (Chr1) for R to run on
