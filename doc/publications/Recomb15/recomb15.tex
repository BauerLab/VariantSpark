...
\marginpar{TODO elaborate on accuracy measures Aidan: See above}
...
Although this produces close to the optimal solution for the initial cluster centres, these initial cluster centres are different for each model.
Due to the amount of variance in the 1000 Genomes dataset, it's possible that multiple local optima are close to the global optimum, and the algorithm
is choosing one that doesn't represent population structure.
