...
%\marginpar{``bigdata genomics'' seems to be a domain name \url{http://bdgenomics.org/} --  how should we cite this}
...
features to be taken into account. %, as done by RF and DL.
...
Java, which limits the random forest implementation of {\sc Spark}'s {\sc MLlib} to approximately 10 million features for the 1096 individuals
