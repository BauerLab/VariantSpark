...
% Denis: umm correct/total happend to be 0.84 too ? or are you quoting here the ARI ? I want to have the same accuracy measure as reported by bdgenomics for all comparisons in this paper
