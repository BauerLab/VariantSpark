...
\marginpar{I don't understand this. Can't you just sak a patient about their ancestry?}
...
\marginpar{not sure what is meant here. RF, LR etc are not multivariate -- there is only one $y$ variable, obesity. They
are multi-variable.}
