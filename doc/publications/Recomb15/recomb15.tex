...
however, improves upon this result.  With this approach, we achieve an ARI of 1 across the ten folds.
...
\marginpar{TODO[say that this may be a too easy dataset to benchmark the performance differences between kmeans and RF
  (hence the full dataset needed) Aidan: done(probably)]}
...
logistic regression method compared to the unsupervised \kMeans{} approach or the multivariate deep learning approach as reported by
