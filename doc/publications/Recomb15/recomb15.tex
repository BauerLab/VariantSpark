...
The ARI allows us to compare the classification results with \kMeans{} clustering results, as it takes the partitioning of the dataset into account, rather than just labels.
report the mean error over all training and testing folds
...
Java, which limits the random forest implementation of {\sc Spark}'s {\sc MLlib} to XX features for the 1096 individuals
of the 1000 Genomes Project.  This property would make feature selection mandatory for the 100,000 genome project when classifying their
