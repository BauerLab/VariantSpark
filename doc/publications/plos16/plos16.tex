...
$\delta = n/p$ is small. In the simulated example in section \ref{section:synthetic_data} the underdeterminedness $\delta = 0.002$ and the
...
Fig~\ref{figure:ranger_rbo_Stodden_simulation.png} shosw the OOB prediction error and the RBO error for a random forest with 10000 trees and the \mtry value set
