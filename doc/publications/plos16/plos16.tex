...
lists (in this case, the paramters $w_i, i=1,\ldots , 5$ (equation \ref{equation:synthetic.data}), and the top 1000
ranked variable importances from the \cursedforest model). It is a mesaure of similarity between rankings that handles
list of different length, weighs high ranks more heavily than low, and is monotonic with increasing depth of
