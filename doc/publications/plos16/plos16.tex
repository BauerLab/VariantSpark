...
Fig.~\ref{figure:synth}b illustrates that increasing \mtry\ also improves the OOB
...
Piotr's simulation with $n=1000$ and $p= 10000$
...
Similar to Piotr's simulation with  except $y= w_1x_1 w_2x_2 w_3x_3 w_4x_4 w_5x_5$. $n=1000$ and $p= 10000$
The significant variables can no longer be recovered by single variable tests for correlation with $y$
...
\begin{figure}[tbhp]
\includegraphics[totalheight=6cm]{/home/dun280/Dropbox/random_forests/exploration/figs/ranger.png}
\caption{ ranger}
