...
\marginpar{why not just error rate}
...
\marginpar{is this formulation correct in the case of classification? See Friedman on 0-1 losss}
\begin{equation}
...
of teh set $S$ will be in a GWAs application. There are cases of small groups of SNPs with large effectsd and also of
...
GWAS data. What do we need to do in this area? What about linkage disequilibrium?}
...
\marginpar{these are not actually encoded as factors}
...
\marginpar{in the terminology of statistics, these are all main effects. There are no interaction terms}
...
\marginpar{the accuracy hardly changes}
