...
\section*{Notes}
\begin{itemize}
\item what are you guys editing this with?  what about some carrige
  returns or line feeds or something!
\item Are we going to use the TCGA data in this paper?
\item are we going to run sparkML or Curesed forest on the extended
...
\begin{itemize}
\item \texttt{max_depth} the size (complexity) of the individual trees
