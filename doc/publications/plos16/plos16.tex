...
1~and~2), 
\margin[ar{something wrong here. We do not report on chromosome 1 and 2} 
...
contitions casued by the interaction of large groups of SNPs. 
...
number of samples, this scalability eventuall break down as we include more features.
...
homozygous variant (1\textbar1) as 2.
...
Bernoulli trail with $p$ (probability of success) calculated by applying an inverse logit transformation to the continuous
...
\marginpar{repicated methods section}
...
worker nodes each with 16 Intel Xeon E5-2660@2.20GHz CPU cores and 128 GB of RAM.  We captured the OOB (out of bag)
...
same random seed, to improve consistency of measurements.
...
internode communication is lower) while in the latter case its most likely caused by reaching the clusters computational
capacity.
