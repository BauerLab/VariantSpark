...
\marginpar{check this. It also allows us to set mtry to a large number, important when p is large}
...
\marginpar{this is wrong -- it used Gini}
...
\marginpar{this is not true anymore}
...
\begin{figure}[tbhp] 
  \begin{adjustwidth}{-1.00in}{0in}
    \caption{\textbf{ OOB (out of bag) classification error and Rank-biased overlap estimates for random
        forests with 100 trees trained on the synthetic dataset of 2.5M features and 5K samples.}}
    \label{figure:synth1}
