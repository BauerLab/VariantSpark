...
microdeletion in this region have a significant in bone mass\cite{Stagi2010}. In this same region, we also observe
variants present in PRODH (proline dehydrogenase). PRODH catalyzes the first step in proline degradation, and as
proposed by \cite{Phang.2008}, proline is made available by collagen degradation \cite{Phang2008}.
