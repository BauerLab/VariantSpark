...
classification error and the rank-biased-overlap (RBO)
\marginpar{what is wrong with the formatting of this citation?}
...
We observe a p-value of XXXX, supporting our hypothesis that variants in close proximity to the known BMD genes are
...
We also frequently see highly-ranked variants in chromosome 22q11. Stagi2010 observe that individuals with a microdeletion
...
\marginpar{this section is not one sentence? has it been lost?}
