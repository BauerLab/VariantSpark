...
work down to the level of the individual features.  For example, for each node of a tree, \cursedforest will distribute
...
\item the size and complexity of the individual trees is controlled in
  \randomforest by setting \texttt{nodesize}, the minimum size of
...
\ranger, allocating varying number of CPU cores to the \cursedforest\ and also varying computational complexity
