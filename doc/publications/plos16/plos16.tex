...
Thirdly, we demonstrate the scalability of \cursedforest in respect to the dimensionality of the data by building a random
...
\begin{itemize}
  ...
  \item are able to capture interactions between features (which is important for modelling complex polygenic diseases).
  \end{itemize}
...
correspond to an additive effect encoding of genomics variation) randomly generated from a uniform distribution with equal
probabilities.  
...
% rs6702460 1	91536	91536	14	1.0296212827525244E-6
% rs2058553 2	20573002	20573002	15	9.896033178354981E-7
