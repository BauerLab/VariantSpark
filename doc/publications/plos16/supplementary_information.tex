...
\multirow{3}{*}{phase1\_chr22: 1,092 x 490,036} & \cursedforest & 0.04  & 1 min 50 seconds  &  \\ %110 %\cursedforest\ & 0.077 (XX) &                  &                                                                   \\
                                                ...
                                                & RF - R         & 0.05       & 24 min           & 18GB\footnote{using the \texttt{parallel} packages with 10 nodes} \\ %1440
...
\multirow{3}{*}{phase3\_chr22: 2,504 x 1,103,548}   & \cursedforest & 0.06 & 4 min 2 seconds & \\  %240 &               &            &                  &                                                                \\
						  & RF - Spark ML   & 0.06 & 37 min 19 seconds  & \\  %2239
                                                    & RF - R        & NA         & NA               & NA\footnote{long vectors ($> 2^31-1$)  are not supported in the .Fortran interface} \\ %OK
                                                    & ranger - R    & 0.06       & 18 min        & 21GB (one processor) \\ %270
...
\multirow{3}{*}{phase3\_chr1: 2,504 x 6,450,364}    & \cursedforest & 0.04  & 19 min 19 seconds &        \\ %1159   \cursedforest\ & 0.06 & 1hr 58min        & 4GB \\
  ...
  %                                                  & LR - Spark ML  &            & 2hr 6min         & 8GB \\
                                                   & ranger - R      & 0.05       & 1 hour 42 min          & num.threads=10 \\ %\footnote{don't know how to get the memory used, This was done on dpas-03} \\ %1680
...
\multirow{3}{*}{phase3\_chr1-3: 2,504 x 19,328,051} & \cursedforest & 0.02  & 56 min 43 seconds     &        \\ %3403%& 0.04 & 4hr 0min                                             & 4GB \\
  ...
  %                                                  & LR - Spark ML  &            & 14hr 48min                                           & 8GB \\
						 ...
						 %DENIS: is it 6 h 58 m or the above quoted 3 h 58 m ? 
 %                                                   & ranger - R      &  0.03      & 58 mins\footnote{ but took 6 hours to load the data}
 %                                                                                                                                        & 909GB\footnote{I
  %                                                                                                                                         think
  %                                                                                                                                         this
  %                                                                                                                                         is
    ...
    %                                                                                                                                               ntasks-per-node=160
     %                                                                                                                                      cores-per-socket=10
      %                                                                                                                                     on
       %                                                                                                                                    ruby
       %                                                                                                                                    }  \\
						%DENIS: our best result is on this subset is 10 min 49 seconds using 130 worker nodes, each with 8GB RAM so are you sure about the ranger result?
%						& ranger - R        &             0.027     &      03:58           &       pearcey --cpus-per-task=15 --mem 1600gb   906GB \\
