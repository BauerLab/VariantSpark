% This is a separate version of the CursedForest manuscript following Nature Method formatting guidelines. A Word document has been created based on this. See the Word document for the latest version of the paper.
%
% Template for PLoS
...
\begin{flushleft}
{\Large
\textbf\newline{\cursedforest - A Random Forest Machine Learning Implementation for ``Big'' and ``Wide'' Data} % Please use "title case" (capitalize all terms in the title except conjunctions, prepositions, and articles).
}
\newline
...
forests are easy to parallelise, as the forest is a sum of decision trees, it is possible to grow separate
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Overview of Random Forests (This should go to Supplemental Information)}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\cursedforest (This should go to Results section)}
